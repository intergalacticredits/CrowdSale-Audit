...
contract SponseeTokenModel is StandardToken {
    ...
    uint public cap = 7000000000000;                    // maximum cap = 7 000 000 000 000 $ = 100 000 000 000 tokens
    uint public minimumSupport = 500;                   // minimum support is 5$(500 cents)
    uint public etherRatioForInvestor = 1/1000;         // etherRatio (0.001%) to send ether to investor
    ...
    Then, return token of this contract to msg.sender related to the amount of ether that msg.sender sent and rate (US cent) of ether stored in Rate contract.
    */
    function() payable {
